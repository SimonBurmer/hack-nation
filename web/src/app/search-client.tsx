...
import {
  ...
  protocolValidationIssues,
  readCachedProfile,
  requiredFieldKeys,
  requiredFieldLabels,
  requiredFieldValue,
  skillConfidenceClass,
  skillConfidenceFromSimilarity,
                      ...
                      >
                        ...
                        <div className="rounded-md border border-zinc-200 bg-zinc-50 px-3 py-3 text-sm text-zinc-700">
                          ...
                          <div className="mt-3 space-y-1 text-xs leading-5">
                            ...
                            <p>
                              Essential skills: {matchedEssentialSkillCount} *
                              25 = {formatScoreValue(matchedEssentialScore, 0)}
                            </p>
                            <p>
                              Coverage:{" "}
                              {formatCoverageValue(path.skill_coverage)} * 10 ={" "}
                              {formatScoreValue(coverageScore)}
                            </p>
                            <p>
                              Matched similarity:{" "}
